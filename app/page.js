    ...
    <>
      ...
      <section className="hero">
        <div className="hero-inner">
          ...
          <p className="hero-sub">Όλο το <strong>πολλαπλό βιβλίο</strong> και χιλιάδες <strong>Ψηφιακά Μαθησιακά Αντικείμενα (ΨΜΑ)</strong> — βίντεο, ασκήσεις &amp; διαδραστικό υλικό, όλα σε ένα μέρος</p>
      ...
      <footer className="footer">
        <div style={{ maxWidth: 1100, margin: '0 auto', padding: '0 20px' }}>
          ...
          <p style={{ fontSize: 13, textAlign: 'center' }}>
            Το Portify συγκεντρώνει όλο το <strong>πολλαπλό βιβλίο</strong> και πλέον και <strong>χιλιάδες Ψηφιακά Μαθησιακά Αντικείμενα (ΨΜΑ)</strong> — διαδραστικό υλικό, βίντεο, εικόνες και ασκήσεις. Το πολλαπλό βιβλίο και τα ΨΜΑ προέρχονται από τη <a href="https://ebooksdl.cti.gr" target="_blank" rel="noopener noreferrer">Ψηφιακή Βιβλιοθήκη Μελίσπη</a> του ΙΤΥΕ Διόφαντος.
          </p>
